...
exports.getDayCanChi = getDayCanChi;
exports.getMonthCanChi = getMonthCanChi;
 ...
 */
function convertLunar2Solar(lunarDay, lunarMonth, lunarYear, isLeapMonth = false, timeZone = 7) {
    let a11, b11;
    if (lunarMonth < 11) {
